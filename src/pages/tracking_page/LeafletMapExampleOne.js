...
//         myPositionMarker.setLatLng([markerPosition.latitude, markerPosition.longitude]);
//         // myPositionMarker
...
//         //   2
//         // );
//         map.setView([markerPosition.latitude, markerPosition.longitude]);
//       } else {
//         myPositionMarker = L.marker([markerPosition.latitude, markerPosition.longitude], {
//           icon: myIcon
//         })
...
//           // closeOnClick: false
//         })
//           .setLatLng([markerPosition.latitude, markerPosition.longitude])
//           .setContent(
//             `<Popup>
//         <h6 className="mb-1">${currentVehicle.vrn}</h6>
