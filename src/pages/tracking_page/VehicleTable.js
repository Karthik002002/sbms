      ...
      <AdvanceTableWrapper columns={columns} data={tableData}>
        <Card.Header>
          <Row className="flex-center">
            ...
            >
              <h6 className="fs-0 mb-0 ms-2 text-wrap py-2 py-xl-0 m-auto text-center p-2">
                Vehicle List
              </h6>
            </Col>
            ...
            <Col>
              <div className="d-flex justify-content-center ">
                <select
                  className="border-0 rounded text-wrap h-50"
                  onChange={e => handleStatusChange(e.target.value)}
                >
                  <option value="" key="" className="text-center">
                    Select status
                  </option>
                  <option value="Running" key="running" className="text-center">
                    Running
                  </option>
                  <option value="Idle" key="Idle" className="text-center">
                    Idle
                  </option>
                  <option value="Stopped" key="Stopped" className="text-center">
                    Stopped
                  </option>
                  <option value="Towing" key="Towing" className="text-center">
                    Towing
                  </option>
                  <option value="Parked" key="Parked" className="text-center">
                    Parked
                  </option>
                  <option
                    value="NoNetwork"
