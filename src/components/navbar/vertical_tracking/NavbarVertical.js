...
const NavbarVertical = () => {
  ...
  useEffect(() => {
    fetch('https://sbms.elenageosys.com/user-management/map-vehicles/', {
      // headers: {
      //   Authorization: 'Token 49deb7cf59acb1ffe4b675584a1617ba9afeca68' TODO: remove this before deployment
      // }
    })
          ...
          <Nav className="flex-column" as="ul">
            {routes.map(route => (
              <Fragment key={route.id}>
                {/* {!route.labelDisable && ( */}
                <NavbarLabel label={route.company_name} />
                {/* )} */}
                <NavbarVerticalMenu routes={route.schools} />
                <hr />
              </Fragment>
            ))}
          </Nav>
