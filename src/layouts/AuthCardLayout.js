...
import logo from 'assets/img/logos/elena/logolong.png';
                  ...
                  <div className="position-relative p-4 pt-md-5 pb-md-7">
                    ...
                    <div className="z-index-1 position-relative light">
                      <img
                        ...
                        alt="Elena Logo"
                        width="100%"
                        className="me-2 mb-3 bg-white py-5 px-3 rounded-4"
                      />
                      <Link
                      ...
                      <p className="opacity-75 text-white">
                        ...
                        able to provide you the ability to track and monitor
                        your Busses
                      </p>
                    </div>
                  </div>
